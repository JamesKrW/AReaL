...
import hashlib
from areal.api.agent_args import EnvSpec
...
def build_env_dataset(
    ...
    """
    Filter EnvSpec list by split, and return a sharded MultiEnvDataset.
    ...
    Returns:
        MultiEnvDataset containing only data for the given split and rank.
    """
    split_specs = [spec for spec in envs_config if spec.split == split]
    return MultiEnvDataset(split_specs, base_seed, rank, world_size)